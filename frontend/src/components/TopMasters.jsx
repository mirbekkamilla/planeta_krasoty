    ...
    return (
        <div className='flex flex-col items-center gap-4 mt-8 mb-16 text-[#262626] md:mx-10'>
            ...
            <div className='w-full grid grid-cols-auto gap-4 pt-5 gap-y-6 px-3 sm:px-0'>
                {masters.slice(0, 10).map((item, index) => (
            ...
            <button onClick={() => { navigate('/masters'); scrollTo(0, 0) }} className='bg-[#EAEFFF] text-gray-600 px-12 py-3 rounded-full mt-10'>Все мастера</button>
        </div>
    )
}
