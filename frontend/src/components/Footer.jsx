    ...
    <div className='md:mx-10'>
      <div className='flex flex-col sm:grid grid-cols-[3fr_1fr_1fr] gap-14 my-10 mt-16 md:mt-40 text-sm'>
        ...
        <div>
          ...
          <ul className='flex flex-col gap-2 text-gray-600'>
            <li><a href='tel:+79262586080' className='hover:text-[#262626] transition-colors'>+7 (926) 258-60-80</a></li>
          ...
          <div className='flex items-center gap-4 mt-5 text-gray-600'>
            ...
            <a href='https://wa.me/79262586080' target='_blank' rel='noopener noreferrer' aria-label='WhatsApp' className='hover:text-[#262626] transition-colors'>
              <svg className='w-6 h-6' viewBox='0 0 24 24' fill='currentColor' xmlns='http://www.w3.org/2000/svg'>
